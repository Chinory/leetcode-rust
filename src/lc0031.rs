...
impl Solution {
  /**
  - Runtime: 0 ms, faster than 100.00% of Rust online submissions for Next Permutation.
  - Memory Usage: 2.1 MB, less than 60.53% of Rust online submissions for Next Permutation.
   */
