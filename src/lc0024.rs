...
impl Solution {
  /*
    Runtime: 0 ms, faster than 100.00% of Rust online submissions for Swap Nodes in Pairs.
    Memory Usage: 2.1 MB, less than 42.11% of Rust online submissions for Swap Nodes in Pairs.
  */
